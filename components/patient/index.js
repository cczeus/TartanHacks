    ...
    return (
      <View style={style}>
          ...
          <View style={{ flex: 1, alignSelf: 'flex-end', alignItems: 'center' }}>
            ...
            <View style={{ flexDirection: 'column', flex: 1, marginTop: 25 }}>
              <Text style={{ fontSize: 32, fontWeight: 'bold', color: UITheme.palette.secondaryColor }}>{this.props.numLeft}</Text>
            </View>
